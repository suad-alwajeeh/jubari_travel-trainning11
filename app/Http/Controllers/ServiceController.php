...
public function show_ticket($id)
{
 ...
 ->where(['ticket_services.service_status'=>$id,'ticket_services.deleted'=>0])->paginate(3);
...
public function show_bus($id)
{
 ...
 ->where(['bus_services.service_status'=>$id,'bus_services.deleted'=>0])->paginate(3);
...
public function show_hotel($id)
{
 ...
 ->where(['hotel_services.service_status'=>$id,'hotel_services.deleted'=>0])->paginate(3);
...
public function show_visa($id)
{
 ...
 ->where(['visa_services.service_status'=>$id,'visa_services.deleted'=>0])->paginate(3);
...
public function show_car($id)
{
 ...
 ->where(['car_services.service_status'=>$id,'car_services.deleted'=>0])->paginate(3);
...
public function show_med($id)
{
 ...
 ->where(['medical_services.service_status'=>$id,'medical_services.deleted'=>0,'medical_services.due_to_customer'=> $_SESSION['id']])->paginate(3);
...
public function show_gen($id)
{
 ...
 ->where(['general_services.service_status'=>$id,'general_services.deleted'=>0])->paginate(3);
