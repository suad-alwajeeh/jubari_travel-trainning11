            ...
            <div class="around">
              ...
              <div class="form-row col-md-12 col-sm-12 col-xm-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    <input type="text"  class="form-control select2 select2-hidden-accessible" name="voucher_number" />
                  </div>
                </div>
                <div class="form-group col-md-6 col-sm-12 col-xm-12">
              ...
              <div class="form-row col-md-12 col-sm-12 col-xm-12">
                ...
                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    <input type="text" class="form-control select2 select2-hidden-accessible" name="car_info" />
                  </div>
                </div>
              </div>
            </div>
