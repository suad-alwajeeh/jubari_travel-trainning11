              ...
              <div class="form-row col-md-12 col-sm-12 col-xm-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    ...
                    <input type="text" name="country" class="form-control select2 select2-hidden-accessible" list="cars" />
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    <input type="text" name="visa_type" class="form-control select2 select2-hidden-accessible" list="cars" />
                ...
                <div class="form-group col-md-12 col-sm-12 col-xm-12">
                  ...
                  <div class="form-group" data-select2-id="44">
                    <input type="text" name="visa_info" class="form-control select2 select2-hidden-accessible" name="info" />
                  </div>
                </div>
